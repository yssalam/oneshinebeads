...
@section('main-content')
 ...
 <div class="card shadow mb-4">
    ...
    <div class="card-header py-3">
      <h6 class="m-0 font-weight-bold text-primary float-left">comments Lists</h6>
    </div>
    <div class="card-body">
      <div class="table-responsive">
          ...
          <tbody>
            @foreach($comments as $comment)
                <tr>
                    ...
                    <td>
                        <a href="{{route('comments.edit',$comment->id)}}" class="btn btn-primary btn-sm float-left mr-1" style="height:30px; width:30px;border-radius:50%" data-toggle="tooltip" title="edit" data-placement="bottom"><i class="fas fa-edit"></i></a>
        ...
        <span style="float:right">{{$comment->links()}}</span>
        @else
          <h6 class="text-center">No post commentss found!!!</h6>
        @endif
      </div>
    </div>
</div>
