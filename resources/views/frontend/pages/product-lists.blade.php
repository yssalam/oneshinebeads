...
@section('title','ONE SHINE BEADS || Produk')
						...
						<div class="col-lg-3 col-md-4 col-12">
							<div class="shop-sidebar">
								...
								<div class="single-widget range">
									<h3 class="title">Temukan Harga</h3>
                                ...
                                <div class="single-widget recent-post">
                                    <h3 class="title">Baru Ditambahkan</h3>
                                    {{-- {{dd($recent_products)}} --}}
						...
						<div class="col-lg-9 col-md-8 col-12">
							...
							<div class="row">
								@if(count($products))
														...
														<div class="product-img">
															...
															<div class="button-head">
																<div class="product-action">
																	...
																	<a title="Wishlist" href="{{route('add-to-wishlist',$product->slug)}}" class="wishlist" data-id="{{$product->id}}"><i class=" ti-heart "></i><span>Tambah Ke Keinginan</span></a>
																</div>
									...
									@endforeach
								@else
									<h4 class="text-danger" style="margin:100px auto;">Tidak Ada Produk Terkait.</h4>
								@endif
							</div>
							 <div class="row">
										...
										<div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
											<div class="quickview-content">
												...
												@php
													$after_discount=($product->price-($product->price*$product->discount)/100);
												@endphp
												<h3><small><del class="text-muted">${{number_format($product->price,2)}}</del></small>    Rp. {{number_format($after_discount,2)}}  </h3>
