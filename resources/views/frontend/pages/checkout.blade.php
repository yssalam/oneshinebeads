...
@section('title', 'ONE SHINE BEADS || Pembayaran')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-12">
                        <div class="checkout-form">
                            ...
                            <p>Hanya beberapa langkah lagi untuk menyelesaikan pembelian Anda dengan aman!</p>
                            <!-- Form -->
                            <div class="row">
                                ...
                                <div class="content">
                                    <ul>
                                        <li class="order_subtotal" data-price="{{Helper::totalCartPrice()}}">Total
                                            Belanja<span>Rp.{{number_format(Helper::totalCartPrice(), 2)}}</span></li>
                                        <li class="shipping">
                                            Biaya Pengiriman
                            ...
                            <div class="single-widget">
                                ...
                                <div class="content">
                                    <div class="checkbox">
                                        ...
                                        <input name="payment_method" type="radio" value="cardpay" required> <label> Transfer
                                            Bank</label><br>

                                        <!-- Credit Card Details -->
                                        <div id="creditCardDetails" style="display: none;">
                                            <label > Nomor Kartu :</label>
                                            <label > 901325301721 SEABANK</label>
                                            <label > A/N WANDA WULANDARI</label>
                                            <label > KIRIM BUKTI TRANSFER KE WHATSAPP ADMIN</label>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-service">
                        ...
                        <p>Pesanan kamu akan diproses maksimal H+1 setelah pembayaran dan dikirim menggunakan jasa ekspedisi
                            terpercaya. Kami pastikan produk sampai dengan aman ke tanganmu.</p>
                    </div>
                    <!-- End Single Service -->
                </div>
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-service">
                        ...
                        <p>Ada masalah dengan produk? Tenang, kami menyediakan layanan pengembalian dalam 3 hari setelah
                            barang diterima, sesuai syarat & ketentuan. Kepuasanmu prioritas kami!</p>
                    </div>
                    <!-- End Single Service -->
                </div>
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-service">
                        ...
                        <p>Pembayaran dilakukan via transfer bank atau e-wallet. Setelah itu, unggah bukti transfer di
                            halaman konfirmasi untuk mempercepat proses pengiriman.</p>
                    </div>
                    <!-- End Single Service -->
                </div>
                <div class="col-lg-3 col-md-6 col-12">
                    ...
                    <div class="single-service">
                        <i class="ti-tag"></i>
                        <h4>Harga Terbaik</h4>
                        <p>Dapatkan aksesoris handmade berkualitas dengan harga yang ramah di kantong. Kombinasi sempurna
                            antara desain unik, bahan pilihan, dan harga terbaik hanya di One Shine Beads!</p>
                    </div>
                    <!-- End Single Service -->
                </div>
            </div>
