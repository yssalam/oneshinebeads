...
@endsection
@section('title','ONE SHINE BEADS || Detail Produk')
					...
					<div class="col-12">
						<div class="bread-inner">
							<ul class="bread-list">
								...
								<li class="active"><a href="">Produk Detail</a></li>
							</ul>
						</div>
					</div>
				</div>
									...
									<div class="col-lg-6 col-12">
										<div class="product-des">
											...
											<div class="short">
                                                ...
                                                @endphp
												<p class="price"><span class="discount">Rp.</div>{{number_format($after_discount,2)}}</span><s>Rp.{{number_format($product_detail->price,2)}}</s> </p>
											...
											<div class="product-buy">
												...
												@if($product_detail->stock > 0)
													@if($product_detail->stock < 10)
														<span class="badge badge-warning">Kurang Dari 10</span>
													@else
															...
															<div class="col-12">
																...
																<div class="comment-review">
																	<div class="add-review">
																		<h5>Tambah Ulasan</h5>
																		<p>Note : Alamat email Anda tidak akan dipublikasikan. Hanya username saja yang di tampilkan. </p>
																	</div>
																...
																<p class="text-center p-5">
																	Kamu Harus <a href="{{route('login.form')}}" style="color:rgb(54, 54, 204)">Login</a> Atau <a style="color:blue" href="{{route('register.form')}}">Daftar</a>
                                    ...
                                    <!-- <div class="product-img">
                                        ...
                                        <div class="button-head">
                                            <div class="product-action">
                                                <a data-toggle="modal" data-target="#modelExample" title="Quick View" href="#"><i class=" ti-eye"></i><span>Lihat</span></a>
                                                <a title="Wishlist" href="#"><i class=" ti-heart "></i><span>Tambah ke Keinginan</span></a>
